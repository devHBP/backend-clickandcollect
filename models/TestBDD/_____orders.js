...
const TestOrdersV4 = db.define('TestOrdersV4', {
    orderId: {
...
TestOrdersV4.beforeValidate((order, options) => {
  if (!order.numero_commande) {
      ...
      .then(store => {
        ...
        return TestOrdersV4.max('orderId') // Récupérer l'ID maximal
        .then(maxId => {
