...
const TestProductsV2 = db.define('TestProductsV2', {
...
TestProductsV2.associate = function(models) {
    TestProductsV2.belongsToMany(models.TestOrders, { 
