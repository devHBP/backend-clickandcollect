...
const TestProductsV4 = db.define('TestProductsV4', {
...
TestProductsV4.associate = function(models) {
    TestProductsV4.belongsToMany(models.TestOrders, {
      through: 'TestOrderProducts',
      foreignKey: 'productId',
      otherKey: 'orderId'
    });
  
    TestProductsV4.hasOne(models.TestStocksV2, {
      foreignKey: 'productId'
    });
  };
